...
const PromoCard: React.FC<PromoCardProps> = ({
	color = PromoCardColor.dark,
	icon = IconType.qrIcon,
	img,
	title,
	subtitle,
	className,
	...
	<div className={cn('promo-card', `promo-card_${color}`, className)} onClick={onClick}>
		...
		<div className="promo-card__content">
			<Typo className="promo-card__title" type={TypographyType.h3}
			      weight={TypoWeight.light}>{title}</Typo>
			<div className="promo-card__bottom">
				<Typo className="promo-card__subtitle" type={TypographyType.h2}
				      weight={TypoWeight.light}>{subtitle}</Typo>
