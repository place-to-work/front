...
const ApplePayIcon: React.FC<BaseIconProps> = (props: BaseIconProps) => (
    <BaseIcon {...props} height="800" width="1200" viewBox="-76.79115 -52.55 665.5233 315.3">
...
export default React.memo<BaseIconProps>(ApplePayIcon);
